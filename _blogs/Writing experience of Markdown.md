...
Marp在VS Code里需要安装一系列拓展，而我在ob中使用[Awesome-Marp](https://github.com/favourhong/Awesome-Marp)模板时存在导出PPT模板不显示的情况（[解决方案](https://forum-zh.obsidian.md/t/topic/44135/2)：把themes里的文件后缀名scss都改成css）。
