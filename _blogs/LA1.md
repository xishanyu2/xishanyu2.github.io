...
我的线代学习之路可谓一波三折。大学时期，我曾不止一次学习宋浩的线性代数课程，但都一直止步于第一章行列式；在学校也听过不同老师讲线性代数，大多也是从行列式讲起；虽然学了很多线代的计算方法与技巧，但一直不得其道，于是我喜提大学里唯一一门没有上80分的课程（一门线代毁了我的✕✕梦）。在此之后，我对线性代数“补完”的愿望愈发强烈，在2024年暑假，我又学习了[刘思齐老师的课程](https://www.bilibili.com/video/BV1sH4y1S7gm/?spm_id_from=333.1387.homepage.video_card.click)，虽然只学到特征值和特征向量一章，稍显吃力便没有继续之后的内容，现在也几乎忘光了，但却开始从一个更高的维度重新审视线性代数。
...
经常刷知乎可以看到，在一些“国内教材和国外教材对比”、"教材防自学机制"、"线性代数听不懂"类似的帖子下面，同济版紫皮线代教材一定“榜上有名”、赫然在列。不同于高数、概率论有相对统一的教材，线代的教材五花八门，大多又是照搬同济版。
...
为什么同济线代如此”臭名昭著“？第一个批评当属以行列式开篇，以至于判断线代教材的好坏成了是不是从行列式开始（这种办法不无道理，据此就能排除掉以行列式开始的里面99%的烂教材）。
...
居余马老师的线性代数和谢启鸿老师的高等代数虽同为以行列式起，但居书认为采用简便的递归法即可定义 n 阶行列式，比用逆序法定义更节省学时；谢书也是采用行列式按行展开用数学归纳法定义，不采用逆序数这样复杂的组合定义，也不是采用多重线性交错型这样抽象的公理化定义。我在笔记里这部分也没有过多的笔墨，因为一般不会用逆序数计算行列式，而其它地方也用不到，直接摘除毫无影响。

五、我在整理笔记时遵循的原则

网上前人对于MIT 18.06课程的笔记众多，我为什么还要重新整理呢？

网上对于MIT 18.06课程的笔记大致可分为三代人的努力，第一代见于丁坤博七年前的[github仓库](https://github.com/MLNLP-World/MIT-Linear-Algebra-Notes)，第二代是知乎三少爷的键的[系列笔记](https://zhuanlan.zhihu.com/p/45707832)，后续很多笔记对此都有所参考借鉴，所以到我已经算是第三代了。

眼过千遍，不如手过一遍，只有自己真正过一遍、搭建起自己的知识框架与体系，才能将知识内化为自己的，此为第一点原因；其二，已有笔记或是排版不算美观、或是没有能直接下载的pdf版本、或是内容高度凝练简洁不适合直接作为初学材料。我在整理笔记时牢记以下原则：

- 规范性：采用LaTeX进行排版，部分图形用LaTeX进行绘制。
...
<div align="center">
  <img src="https://ts2.tc.mm.bing.net/th/id/OIP-C.rnl5lx2Gi_w9KIbRBo_iFQHaJH?r=0&rs=1&pid=ImgDetMain&o=7&rm=3" width="150" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
感谢学术开源的前辈们，特别是三少爷的键（知乎）、Photon Hunter（小红书），我从头到尾认真阅读了这两份高质量笔记，吸收了很多精华的内容。

感谢经济学院朱老师、金融学院权老师、软件学院胡老师，前两位老师的自编讲义分别从向量和线性空间讲起，配有思维导图或图形解释；我在小雅上发现了第三位老师的课程，上面提供了丰富的Python代码与可视化资源。

感谢看到这里的你，希望对你的线代学习有启发和帮助，让我们一起感受数学之美！
