...
2026年了，我为什么要重学线性代数？要回答这个问题，需要从两方面讨论。
...
- AI翻译、AI配音、AI画质修复降低了学习门槛。以往只能啃英文原版高糊视频，但如今B站上新了中配版（有人可能会批驳就应该沉浸式体验原汁原味的英文环境，但我们是为了学习线性代数，而不是通过学习线代学英语），母语者在接受母语信息时所需要的理解时间是更短的，等量信息在中文语境下表达所需时间也更少（中文能承载更高密度信息量）；另外一些专业词汇以及GS有很多口癖对初学者不太友好。
...
<div align="center">
  <img src='/images/屏幕截图 2026-08-26 1059356.png' />
</div>
